...
class Beta(Distribution):
  ...
  :Attributes:
    ...
    - input_type (any): Change meaning of mean and stdv to alpha and beta (better)\n
  ...
  def __init__(self, name,mean,stdv,a=0,b=1,input_type=None,startpoint=None):
    ...
    self.rv = stats.beta(p1, p2, loc=a, scale=b-a)

  def setMarginalDistribution(self):
    """Compute the marginal distribution
    :Returns:
        -mean, stdv, q, r, a, b: mean, stdv, Alpha, Beta, Lower bound, Upper bound
    """
